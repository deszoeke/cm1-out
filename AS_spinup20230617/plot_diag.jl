...
contour(t/24, zs, qc, levels=[1e-7, 1e-6], linewidth=0.1, colors=["g"], linestyles="-") #, cmap=ColorMap("RdYlBu_r"))
# colorbar()
contour(t/24, zs, th, colors=["k"], linewidth=0.1, levels=280:2:500)
ylim([0,16])
